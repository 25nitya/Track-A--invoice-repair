...
def export_csv(db):
    ...
    for row in invoices(db):
        ...
        for key in ('amount', 'paid', 'balance'):
            # The old conversion multiplied by 100 and used int(), which
            # truncated floating-point values such as 19.99 to 19.98.
            # Formatting directly to two decimal places preserves the intended
            # currency value for the CSV output.
